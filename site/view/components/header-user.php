<div class="header-top">
    <div class="d-flex justify-content-between align-items-center container">
        <a href="./?page=home">
            <img src="./view/img/Xshop-logo.png" alt="" class="logo img-fluid" style="max-width: 150px" />
        </a>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color: var(--primary);">
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php
                include isset($_COOKIE['id']) ? './site/view/components/header-user-control.php' : './site/view/components/header-user-login.php';
                ?>
            </div>
        </div>
    </nav>
