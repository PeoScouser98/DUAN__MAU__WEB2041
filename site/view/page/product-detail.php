    ...
    <div class="container row bg-white mx-auto px-0">
        ...
        <div class="container col-9 row d-flex flex-column gap-5 py-5" style="max-width:100%; margin: 0 auto;">
                ...
                <div class="container d-flex flex-column gap-4 py-3" id="comment-list" style="max-height: 10rem;">
                    ...
                    ?>
                            ...
                            <div class="d-flex justify-content-start gap-5 border-end-1">
                                <div class="">
                                    <img src=<?= $ROOT_AVATAR . $avatar ?> class="rounded-circle object-fit-cover" style="max-width:40px; height:40px">
                                </div>
                                <div class="w-100">
            ...
            <div class="container ps-0">
                ...
                <?php
                render_products("SELECT * FROM product WHERE cate_id = {$product['cate_id']} AND product_id NOT IN (SELECT product_id FROM `product` WHERE product_id = {$product['product_id']})");
                ?>
            </div>
        </div>
    </div>
